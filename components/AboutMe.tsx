...
export default function About() {
  return (
    <div className="flex flex-col justify-center items-center h-screen px-4">
      ...
      <div className="text-center mx-auto max-w-prose text-lg space-y-4">
